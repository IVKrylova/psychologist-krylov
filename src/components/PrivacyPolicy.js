  ...
  return (
    <section className="section privacy-policy">
      ...
      <ul className="privacy-policy__list">
        ...
        <li>
          <p className="privacy-policy__text">
            ...
            Пользователю веб-сайта&ensp;<a className="privacy-policy__link" href="https://www.alekseykrylov.ru">https://www.alekseykrylov.ru</a>;
          </p>
        </li>
        <li>
          <p className="privacy-policy__text">
            2.9. Пользователь – любой посетитель веб-сайта&ensp;<a className="privacy-policy__link" href="https://www.alekseykrylov.ru">https://www.alekseykrylov.ru</a>;</p>
        </li>
        <li>
          <p className="privacy-policy__text">
      ...
      <ul className="privacy-policy__list">
        ...
        <li>
          <p className="privacy-policy__text">
            ...
            самостоятельно через специальные формы, расположенные на сайте&ensp;<a className="privacy-policy__link" href="https://www.alekseykrylov.ru">https://www.alekseykrylov.ru</a>.
      ...
      <ul className="privacy-policy__list">
        ...
        <li>
          <p className="privacy-policy__text">
            6.3. Срок обработки персональных данных является неограниченным. Пользователь может в любой момент отозвать свое
